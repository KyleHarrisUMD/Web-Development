...
$sql_2 = "SELECT * FROM inst_users WHERE email = '".$email."' AND password = '".$enc_pass."';";
...
if($id == null)
{
    ...
    include($path.'/inst_login_form_copy.html');
}else
{
    $cu ='';
    $cu = $user_creator->createNewUser($id);
    //$cu->toString();
    header( 'Location: http:/inst_profile.php');
}
?>
