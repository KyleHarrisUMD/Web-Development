...
try
{
    ...
    {
        $delete_mentor_query = "DELETE FROM mentors WHERE id = '".$id."' AND s_o_p = 'SEEK' ; ";
        $q_r->runQueryWithRes($delete_mentor_query);
    }
    foreach($assist_mentor_array as $element)
    {
        $t_s = "INSERT INTO mentors VALUES('".$id."','SEEK','".$element."');";
...
try
{
    ...
    {
        $delete_job_query = "DELETE FROM jobs WHERE id = '".$id."' AND s_o_p = 'SEEK'; ";
        $q_r->runQueryWithRes($delete_job_query);
    }
    foreach($assist_job_array as $element)
    {
        $j_q = "INSERT INTO jobs VALUES('".$id."','SEEK','".$element."');";
...
{
    $delete_instruct_query = "DELETE FROM instructor WHERE id = '".$id."' AND s_o_p = 'SEEK' ; ";
    $q_r->runQueryWithRes($delete_instruct_query);
}
foreach($assist_instruct_array as $e)
{
    $t = "INSERT INTO instructor VALUES('".$id."','SEEK','".$e."');";
    echo $t."<br>";
