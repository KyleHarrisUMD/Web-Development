            ...
            <div id ="tbl_div" align="center">
                <table id = "nav_table">
                    <tr>
                        ...
                        $ss = substr($id , 5);
                        ?>
                        <td  class="nav_section" style="font-size:150%"><a href="view_inst_profile.php?tgt_usr=<?php echo $ss;?>">About</a></td>
                        <td  class="nav_section" style="font-size:150%"><a href="view_inst_gallery.php?tgt_usr=<?php echo $ss;?>">Gallery </a></td>
                        <td  class="nav_section" style="font-size:150%"><a href="view_inst_posts.php?tgt_usr=<?php echo $ss;?>">Posts </a></td>
                   </tr>
                </table>
            </div>
        </header>
